...
Concurrent sessions in one repo can be isolated with native git worktrees instead of keeping multiple physical clones (opt in per repo, default off): see [docs/parallel-work.md](docs/parallel-work.md).
